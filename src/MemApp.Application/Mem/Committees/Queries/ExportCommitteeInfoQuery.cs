...
{
    public class ExportCommitteeInfoQuery : IRequest<ExportCommitteeInfo>
    {
        public int Id { get; set; }
    }


    public class ExportCommitteeInfoQueryHandler : IRequestHandler<ExportCommitteeInfoQuery, ExportCommitteeInfo>
    {
        private readonly IMemDbContext _context;
        //private readonly IUserLogService _userLogService;
        //private readonly ICurrentUserService _currentUserService;
        public ExportCommitteeInfoQueryHandler(IMemDbContext context, ICurrentUserService currentUserService, IUserLogService userLogService)
        {
            _context = context;
        ...
        public async Task<ExportCommitteeInfo> Handle(ExportCommitteeInfoQuery request, CancellationToken cancellationToken)
        {
