...
{
    public class ExportSubCommitteeDetailQuery : IRequest<List<ExportCommitteeDetail>>
    {
    ...
    public class ExportSubCommitteeDetailQueryHandler : IRequestHandler<ExportSubCommitteeDetailQuery, List<ExportCommitteeDetail>>
    {
        private readonly IMemDbContext _context;
      
        //private readonly IUserLogService _userLogService;
        //private readonly ICurrentUserService _currentUserService;
        public ExportSubCommitteeDetailQueryHandler(IMemDbContext context, ICurrentUserService currentUserService,
        ...
        public async Task<List<ExportCommitteeDetail>> Handle(ExportSubCommitteeDetailQuery request, CancellationToken cancellationToken)
        {
