...
{
    public class UpdateMemberTempCommand : IRequest<MemberTempVm>
    {
        public int MemberId { get; set; }
    }

    public class UpdateMemberTempCommandHandler : IRequestHandler<UpdateMemberTempCommand, MemberTempVm>
    {
        private readonly IMemDbContext _context;
        private readonly IMediator _mediator;
        private readonly ICurrentUserService _currentUserService;
        public UpdateMemberTempCommandHandler(IMemDbContext context, IMediator mediator,  ICurrentUserService currentUserService)
        {
            _context = context;
            _mediator = mediator;
            _currentUserService = currentUserService;
        }
        public async Task<MemberTempVm> Handle(UpdateMemberTempCommand request, CancellationToken cancellation)
        {
